---
title: "James–Stein Estimator and Ridge Regression"
format: html
editor: visual
author: Fengyuan Shen (Vincent)
---

## Implement the James-Stein Estimator
...
ggplot(data) +
  geom_point(aes(x = Index, y = Original, color = "Original"), pch = 19) +
  geom_point(aes(x = Index, y = JamesStein, color = "James-Stein Estimation"), pch = 8) +
  scale_color_manual(values = c("Original" = "#d62828", "James-Stein Estimation" = "#003049")) +
...
## Simulate effectiveness of James-Stein Estimator compared to MLE
...
ggplot(results, aes(x = Estimator, y = log(Error + 1), fill = Estimator)) +
  ...
  scale_fill_manual(values = c("err_MLE" = "#778da9", "err_JSE" = "#d62828"))
```
